...
<x-layouts.app title="Search">
    <div class="flex flex-col p-4">
        ...
        <div class="mb-6 pt-4 text-center">
            ...
            <p class="mt-1 text-sm text-gray-500">Ask anything about your stuff</p>
        </div>
                        ...
                        <a href="{{ route('items.show', $item) }}"
                           class="flex items-center gap-3 rounded-2xl bg-white px-4 py-3 shadow-sm">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                @if($item->location?->photos->isNotEmpty())
                                    <p class="text-xs text-gray-400">📷 Location has a photo</p>
                                @endif
                            </div>
